...
# Processing, and Research Environment (AOSPRE) system code. 
# You will need to specify a few items in order to complete the
...
# Operating directory
operating_dir=/export/wind1/bradklotz/AOSPRE/run_tests/WRF_supercell_100m

# Output base directory
output_base_dir=/export/wind1/bradklotz/AOSPRE
